...
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/w1/aml_wifi_rf.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf.txt
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/w1/aml_wifi_rf_iton.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_iton.txt
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/w1/aml_wifi_rf_ampak.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_ampak.txt
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/w1/aml_wifi_rf_fn_link.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_fn_link.txt
else
PRODUCT_COPY_FILES += vendor/wifi_driver/amlogic/w1/wifi/project_w1/vmac/aml_wifi_rf.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf.txt
PRODUCT_COPY_FILES += vendor/wifi_driver/amlogic/w1/wifi/project_w1/vmac/aml_wifi_rf_iton.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_iton.txt
PRODUCT_COPY_FILES += vendor/wifi_driver/amlogic/w1/wifi/project_w1/vmac/aml_wifi_rf_ampak.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_ampak.txt
PRODUCT_COPY_FILES += vendor/wifi_driver/amlogic/w1/wifi/project_w1/vmac/aml_wifi_rf_fn_link.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1/aml_wifi_rf_fn_link.txt
endif
...
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/aic_userconfig.txt:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/aic_userconfig.txt
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/fmacfw.bin:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/fmacfw.bin
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/fmacfw_rf.bin:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/fmacfw_rf.bin
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/fw_adid_u03.bin:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/fw_adid_u03.bin
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/fw_patch_table_u03.bin:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/fw_patch_table_u03.bin
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/aic/fw_patch_u03.bin:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/fw_patch_u03.bin
