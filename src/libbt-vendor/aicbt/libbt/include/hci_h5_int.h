...
#define HCI_VSC_BLE_GET_CONTROLLER_ACTIVITY_INFO 0xFD59
...
#define HCI_VSC_FW_LOG_ENABLE_SET            HCI_VSC_UPDATE_CONFIG_INFO_CMD//FOR AIC FW LOG ENABLE
#define HCI_VSC_FW_VERSION_GET               HCI_VSC_UPDATE_CONFIG_INFO_CMD//FOR AIC GET FW VERSION
#define HCI_VSC_ASSERT_RESUME_SET            HCI_VSC_UPDATE_CONFIG_INFO_CMD//FOR AIC SET ASSERT RESUME
...
#define HCI_VSC_FW_LOG_ENABLE_SET_SIZE       HCI_VSC_UPDATE_CONFIG_INFO_SIZE
#define HCI_VSC_FW_VERSION_GET_SIZE          HCI_VSC_UPDATE_CONFIG_INFO_SIZE
#define HCI_VSC_ASSERT_RESUME_SET_SIZE       HCI_VSC_UPDATE_CONFIG_INFO_SIZE
