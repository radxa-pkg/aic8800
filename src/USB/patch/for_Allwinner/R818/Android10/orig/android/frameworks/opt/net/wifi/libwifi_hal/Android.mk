...
LOCAL_CPPFLAGS   += -DWIFI_DRIVER_MODULE_PATH=\"$(WIFI_DRIVER_MODULE_PATH)\"
endif
LOCAL_CPPFLAGS   += -DBOARD_WIFI_VENDOR_COMMON
LOCAL_C_INCLUDES += hardware/aw/wireless/hwinfo
LOCAL_CPPFLAGS   += -include libhwinfo.h
LOCAL_CPPFLAGS   += -include dirent.h
LOCAL_WHOLE_STATIC_LIBRARIES += libhwinfo
endif
ifeq ($(BOARD_WIFI_VENDOR), realtek)
LOCAL_CPPFLAGS   += -DRTL_WIFI_VENDOR
LOCAL_CPPFLAGS   += -include dirent.h
endif
