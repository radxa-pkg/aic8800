...
static int wpas_p2p_create_iface(struct wpa_supplicant *wpa_s)
{
	...
	if (property_get("vendor.wifi_name", wifi_status, NULL) && os_strncasecmp(wifi_status, "bcm", 3) != 0 && os_strncasecmp(wifi_status, "uwe", 3) != 0 && os_strncasecmp(wifi_status, "aic", 3) != 0)
