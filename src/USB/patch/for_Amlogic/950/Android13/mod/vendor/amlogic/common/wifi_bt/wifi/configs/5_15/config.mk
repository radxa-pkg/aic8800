...
WIFI_SUPPORT_DRIVERS += aic8800
aic8800_build ?= true
aic8800_modules ?= aic8800
aic8800_src_path ?= $(DRIVER_DIR)/aic
aic8800_copy_path ?=
aic8800_build_path ?= aic8800
aic8800_args ?=
ifeq ($(aic8800_build),true)
WIFI_BUILT_MODULES += $(aic8800_modules)
endif
